...
class Sentence():
    ...
    def mark_mine(self, cell):
        ...
        # Removes mine from sentence and updates count
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in range(-1, 2):
            for j in range(-1, 2):
                ...
                if new_cell[0] in range(8) and new_cell[1] in range(8):
                    cells.add(new_cell)
        ...
        for sentence_1 in self.knowledge:
            for sentence_2 in self.knowledge:
                if not sentence_1.__eq__(sentence_2):
                    if sentence_2.cells.issubset(sentence_1.cells) and sentence_1.cells\
                    and sentence_2.cells:
                        sentence_1.cells.difference_update(sentence_2.cells) 
                        sentence_1.count -= sentence_2.count    

        # Infer mines from the AI's knowledge base 
        new_mines = set()              
        for sentence in self.knowledge:                        
        ...
        # Infer safes from the AI's knowledge base 
        new_safes = set()              
        for sentence in self.knowledge:                
            if sentence.count == 0:
        ...
        updated_knowledge = [sentence for sentence in self.knowledge if len(sentence.cells) > 0]     
    ...
    def make_random_move(self):
        ...
        # Reduces moves using the AI's knowledge base
